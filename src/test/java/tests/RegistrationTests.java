...
public class RegistrationTests extends TestBase {
    ...
    public void registrationEmptyEmail() {
        ...
        User user = new User().setFirstName("Lisa").setLastName("Snow").setEmail("").setPassword("Ssnow12345$");
    ...
    public void registrationEmptyPassword() {
        ...
        User user = new User().setFirstName("Lisa").setLastName("Snow").setEmail("snow" + i + "@gmail.com").setPassword("");
